%--------------------------------------------------------------------------
% PMA_EnumerationAlg_v8_coder.m
% Generate MEX-function for PMA_EnumerationAlg_v8
%--------------------------------------------------------------------------
%
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% files
org_name = 'PMA_EnumerationAlg_v8'; % function that should be mexed
mex_name = 'PMA_EnumerationAlg_v8_mex'; % mex function name
test_name = 'PMA_EnumerationAlg_v8_test'; % test function
