%--------------------------------------------------------------------------
% PMA_EnumerateAlg1_coder.m
% Generate MEX-function for PMA_EnumerateAlg1
%--------------------------------------------------------------------------
% 
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% files
org_name = 'PMA_EnumerateAlg1'; % function that should be mexed
mex_name = 'PMA_EnumerateAlg1_mex'; % mex function name
test_name = 'PMA_EnumerateAlg1_test'; % test function
...
ARGS{1}{6} = coder.typeof(uint8(0),[1 Inf],[0 1]); % cVf
ARGS{1}{7} = coder.typeof(uint8(0)); % dispflag
