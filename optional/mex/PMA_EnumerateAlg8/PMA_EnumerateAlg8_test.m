%--------------------------------------------------------------------------
% PMA_EnumerateAlg8_test.m
% Test function for PMA_EnumerateAlg8
%--------------------------------------------------------------------------
% 
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
function PMA_EnumerateAlg8_test
...
% original
[output11,output12] = PMA_EnumerateAlg8(V,E,SavedGraphs,id,A,B,iInitRep,cVf,Vf,counts,M,Mflag,Bflag,dispflag);
...
try
    % run mex version
    tic
    [output21,output22] = PMA_EnumerateAlg8_mex(V,E,SavedGraphs,id,A,B,iInitRep,cVf,Vf,counts,M,Mflag,Bflag,dispflag);
    if displevel, toc, end
