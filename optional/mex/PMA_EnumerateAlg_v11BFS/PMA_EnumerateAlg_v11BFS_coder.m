%--------------------------------------------------------------------------
% PMA_EnumerateAlg_v11BFS_coder.m
% Generate MEX-function for PMA_EnumerateAlg_v11BFS
%--------------------------------------------------------------------------
% 
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% files
org_name = 'PMA_EnumerateAlg_v11BFS'; % function that should be mexed
mex_name = 'PMA_EnumerateAlg_v11BFS_mex'; % mex function name
test_name = 'PMA_EnumerateAlg_v11BFS_test'; % test function
