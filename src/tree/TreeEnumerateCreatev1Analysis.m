...
%--------------------------------------------------------------------------
function [SavedGraphs,id] = TreeEnumerateCreatev1Analysis(V,E,SavedGraphs,id,A,cVf,dispflag,prenode)
	...
	for iR = I
        ...
        if any(V2) % recursive call if any remaining vertices
            [SavedGraphs,id] = TreeEnumerateCreatev1Analysis(V2,E2,SavedGraphs,id,A,cVf,dispflag,node);
