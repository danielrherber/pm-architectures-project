...
%--------------------------------------------------------------------------
function [SavedGraphs,id] = PMA_StochasticAlg1(V,E,SavedGraphs,id,A,cVf,dispflag)
