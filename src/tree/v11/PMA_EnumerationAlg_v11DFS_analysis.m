...
function [SavedGraphs,id] = PMA_EnumerationAlg_v11DFS_analysis(V,E,SavedGraphs,id,...
    ...
    global node nodelist labellist % modification for analysis function
    ...
    for iR = I
        ...
        if any(V2) % recursive call if any remaining vertices
            [SavedGraphs,id] = PMA_EnumerationAlg_v11DFS_analysis(V2,E2,SavedGraphs,id,cVf,Vf,iInitRep,counts,A2,Bflag,B,Mflag,M,displevel,node);
